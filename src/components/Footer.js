...
export default function Footer() {
  return (
    <>
      <div className="styles__Container-z2pj6q-0 bottomCard">
              <div className="styles__Content-z2pj6q-1 bottomCardText"><span>Let’s talk about your project</span>
                  <p>Ready to take it to the next level? Contact us today and find out how our expertise can help
                      your business grow.</p>
              </div><a className="Button__StyledLink-t1csmo-0 cardButton" href="/contact">Get in touch</a>
          </div>
      <footer className="styles__Footer-sc-1xjizq-0 footerContainer">
          <div className="styles__InnerWrapper-sc-1xjizq-1 footrtInnerContainer">
              <nav className="styles__Nav-sc-1xjizq-2 footerMain">
                  <div className="styles__LogoWrapper-sc-1xjizq-3 footerLogo"><a aria-current="page" className=""
                      href="/"><img
              ...
              <div className="styles__ContactWrapper-sc-1xjizq-6 footerBottom">
                  <div className="styles__ContactRow-sc-1xjizq-4 footerBottomText">
                      <h4>Designo
                          Central Office
                  ...
                  <ul className="styles__SocialsList-sc-1xjizq-5 footer-Social-Icons">
