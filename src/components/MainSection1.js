...
export default function MainSection1() {
  return (
    <main>
      <section className="styles__Hero-sc-15m2wzt-0 mainSection1">
        <div className="col-1">
          <h1>Award-winning custom designs and digital branding solutions</h1>
          <p>With over 10 years in the industry, we are experienced in creating fully responsive websites,
            app design, and engaging brand experiences. Find out more about our services.</p><a
              className="Button__StyledLink-t1csmo-0 cardButton" href="/">Learn more</a>
        </div>

        <div className="col-2">
          <div data-gatsby-image-wrapper="" style={{ width: '624px', height: '913px' }} 
          >
